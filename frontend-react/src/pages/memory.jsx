  ...
  return (
    <div className="screen anim-screen">
      ...
      <div className="pad">
        ...
        {sorted.length === 0 ? (
          <div className="empty-state" style={{ minHeight: 0, flex: 1, padding: "20px 28px" }}>
            <img className="empty-state-img" src="/assets/empty-memory.png" alt="" style={{ width: "min(300px, 70vw)", maxHeight: "50vh", objectFit: "contain" }} />
