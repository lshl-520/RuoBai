...
const statements = [
  ...
  `
    CREATE TABLE IF NOT EXISTS characters (
      ...
      visual_mode VARCHAR(16) DEFAULT 'builtin',
      visual_preview_url VARCHAR(500) DEFAULT NULL,
      live2d_asset_id VARCHAR(80) DEFAULT NULL,
      live2d_model_url VARCHAR(500) DEFAULT NULL,
      live2d_manifest JSON DEFAULT NULL,
      visual_frame_config JSON DEFAULT NULL,
      mood INT DEFAULT 80,
      intimacy INT DEFAULT 50,
      chat_credential_id INT DEFAULT NULL,
      chat_model_id VARCHAR(100) DEFAULT NULL,
      ...
      moment_response_enabled TINYINT(1) DEFAULT 0,
...
const schemaFixups = [
  ...
  { table: 'characters', column: 'moment_response_enabled', definition: 'TINYINT(1) DEFAULT 0', after: 'auto_moments_last_posted_at' },
  ...
  { table: 'characters', column: 'visual_mode', definition: "VARCHAR(16) DEFAULT 'builtin'", after: 'portrait_custom_url' },
  { table: 'characters', column: 'visual_preview_url', definition: 'VARCHAR(500) DEFAULT NULL', after: 'visual_mode' },
  { table: 'characters', column: 'live2d_asset_id', definition: 'VARCHAR(80) DEFAULT NULL', after: 'visual_preview_url' },
  { table: 'characters', column: 'live2d_model_url', definition: 'VARCHAR(500) DEFAULT NULL', after: 'live2d_asset_id' },
  { table: 'characters', column: 'live2d_manifest', definition: 'JSON DEFAULT NULL', after: 'live2d_model_url' },
  { table: 'characters', column: 'visual_frame_config', definition: 'JSON DEFAULT NULL', after: 'live2d_manifest' },
